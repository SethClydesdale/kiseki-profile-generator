    ...
    updateProfile : function (caller, type) {
      switch (type) {
        case 'lang' :
          ...
          if (caller.value == 'en') {
            document.getElementById('typing-with-mishy').href = 'https://sethclydesdale.github.io/typing-with-mishy/lang/en/';
            document.getElementById('typing-with-mishy-img').src = 'aeon-system/images/typing-with-mishy.jpg';
            document.getElementById('tio-plato-is-the-best-img').src = 'aeon-system/images/tio-plato-is-the-best.jpg';
            ava.innerHTML = AeonSystem.cache.opts_avatar;
            ava.value = selected;
            
          } else {
            document.getElementById('typing-with-mishy').href = 'https://sethclydesdale.github.io/typing-with-mishy/';
            document.getElementById('typing-with-mishy-img').src = 'aeon-system/images/typing-with-mishy-ja.jpg';
            document.getElementById('tio-plato-is-the-best-img').src = 'aeon-system/images/tio-plato-is-the-best-ja.jpg';
